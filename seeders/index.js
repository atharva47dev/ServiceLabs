...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'p0QbESNZ4QjjpKG',
      'isDeleted':false,
      'username':'Isabella_Collins',
      'email':'Cecil.Wilderman@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Isabella_Collins' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'oX5JOyiTBFEkyKc',
      'isDeleted':false,
      'username':'Mose_Pacocha40',
      'email':'Belle46@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Mose_Pacocha40' }, userToBeInserted,  { upsert: true });
...
async function seedRouteRole () {
  try {
    const routeRoles = [ 
      ...
      {
        route: '/admin/tickets/count',
        role: 'System_User',
        method: 'POST' 
      },
      {
        route: '/admin/tickets/update/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/tickets/partial-update/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/tickets/updatebulk',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/tickets/softdelete/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/tickets/softdeletemany',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/tickets/delete/:id',
        role: 'System_User',
        method: 'DELETE'
      },
      {
        route: '/admin/tickets/deletemany',
        role: 'System_User',
        method: 'POST'
      },
      {
