...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Al.Schmitt94',
      password: 'aEfDMUAruFjUY9z',
      email: 'Benjamin83@gmail.com',
      name: 'Mrs. Pat Moen',
      userType: 195,
      team: 'New',
      mobileNo: '(725) 760-7331',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 211,
      loginReactiveTime: '2024-03-19T08:07:50.315Z',
      ssoAuth: { googleId: 'Cheese' },
      id: '64784ddad6e912be9a81193e'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Chaz.Cormier',
        'password':'y2jOgwLHTdWm9xz',
        'email':'Lera.Wolff@gmail.com',
        'name':'Robin Barton',
        'userType':authConstant.USER_TYPES.User,
        'team':'Response',
        'mobileNo':'(745) 719-2128',
        'ssoAuth':{ 'googleId':'Oval' },
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Lera.Wolff@gmail.com', });
